(function (window) {
  ...
  QUnit.test( "One busy coffee truck", function( assert ) {
    assert.propEqual(myTruck.createOrderTest({ emailAddress: 'me@goldfinger.com', coffee: 'double mocha'}) , {'me@goldfinger.com': { emailAddress: 'me@goldfinger.com', coffee: 'double mocha'}} , "Passed");
    assert.propEqual(myTruck.createOrderTest({ emailAddress: 'dr@no.com', coffee: 'decaf'}) ,{'dr@no.com' : { emailAddress: 'dr@no.com', coffee: 'decaf'}, 'me@goldfinger.com': { emailAddress: 'me@goldfinger.com', coffee: 'double mocha'}}, "Passed");
    assert.propEqual(myTruck.createOrder({ emailAddress: 'm@bond.com', coffee: 'earl grey'}) , undefined, "Passed");
